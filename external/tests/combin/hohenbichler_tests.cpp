...
namespace Deltares
{
    namespace ProbLibTests
    {
        ...
        void HohenbichlerTest::NoCorrelation()
        {
            ...
            double expectedpf2pf1 = conversions::QfromBeta(beta2);
            ...
            EXPECT_EQ(result.second, ConvergenceStatus::success);
        }
        ...
        void HohenbichlerTest::negativeCorrelation()
        {
            ...
            EXPECT_EQ(result.second, ConvergenceStatus::noConvergence);
        }
        ...
        void  HohenbichlerTest::RhoLimit()
        {
            ...
            for (int iBeta = 1; iBeta <= nBeta; iBeta++)
            {
                ...
                double p; double pfU;
                conversions::PQfromBeta(betaV, p, pfU);
                lunOut <<
                    "* ---------------------------------------------" << std::endl <<
