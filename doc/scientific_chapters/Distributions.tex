...
In the \probLib this is done using the methods of \cite{Wichura1988} and \cite{Hall_etall_1968}. Both methods are in double precision.
...
This paragraph lists all distribution types supported by the \probLib. In theory, endless distribution types exist. All distributions have the following properties:
