...
The correlation factor $\rho_{\text{pq}}$ between two variables $p$ and $q$ is an indication how much they are related to each other. The correlation can vary from -1 (fully anti-correlated) to 0 (uncorrelated) to 1 (fully correlated). Values in between indicate a partial correlation.

The Pearson correlation factor, which is used in the Probabilistic Library, is calculated as follows:
