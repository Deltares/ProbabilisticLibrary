...
When combining the design points integrated during the reliability calculation for a single component,
the failure definitions are merged to one failure definition.
This combined failure definition is used in one of the reliability techniques
(see \autoref{sec:ReliabilityTechniques}).

When using FORM with integrated combining of design points,
results are not reliable.
Therefore \probLib prevents this combination.
