...
In discrete distributions the probability is only defined at at a limited, countable number of $x$-values. In this case a PDF is not possible, because no derivative is available. Instead the PMF, the probability mass function is used. All PMF values sum up to 1.
