...
The Frank and Gumbel copulas do not have a closed form for the inverse calculation of the dependent stochastic variable,
so for each sample a non linear equation has to be solved using numerical bisection.

The copulas Clayton, Frank and Gumbel depend on a parameter $\theta$.
