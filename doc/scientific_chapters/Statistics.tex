...
\begin{itemize}
	...
	\item Prior distribution $P$: Used when fitted from data and a prior distribution. The prior distribution often defined an overall or long term known distribution, which is used to derive a distribution for a specific occasion. Only applicable for a few distribution types.
\end{itemize}
