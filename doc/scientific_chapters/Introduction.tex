...
This document describes the scientific background of the \probLib \textbf{\probLibVersion}.

\section{Overview of this document}

\Autoref{chp:Statistics} covers distribution functions and correlation models available in the \probLib. \Autoref{chp:Sensitivity} and \autoref{chp:OutputUncertainty} present techniques for sensitivity analysis and uncertainty analysis, respectively. \Autoref{chp:Reliability} describes reliability analysis for both individual components and systems of components, along with the available reliability methods.