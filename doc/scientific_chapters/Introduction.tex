...
To calculate an accurate probability of failure, survived situations can be used.
Even lots of effort have been put in measuring input values,
it is impossible to know the subsoil in long stretches of dikes completely.
So it might be possible that a model predicts dike failure,
while in reality it has been observed that the dike has survived.
\probLib uses these events to update the probability of failure.
...
See \autoref{sec:Sensitivity} and \autoref{chp:OutputUncertainty} for more information.
