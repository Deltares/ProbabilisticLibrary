...
The components are combined with methods given in \autoref{chp:CombiningFailureProbabilities}.
...
These techniques will be described in detail in the \autoref{chp:ReliabilityAnalysis}.
...
More details on this type of correlation models are described in \Aref{chp:Correlations}.
