...
In the \probLib the standardized space that is used is the standard normal space.
...
\Note{in \hr, this process is far less complex as correlation is usually limited to pairs of variables.
