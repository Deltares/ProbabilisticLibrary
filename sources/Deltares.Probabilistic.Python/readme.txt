The batch files have the following meaning
...
build sphinx documentation: in folder Deltares.Probabilistic.PWrapper, run: Deltares.Probabilistic.PWrapper>    sphinx-build -b html ../../docs ../../docs/build/html