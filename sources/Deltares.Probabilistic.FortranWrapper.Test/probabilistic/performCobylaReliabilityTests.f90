...
! All rights reserved.
!
module performCobylaReliabilityTests
    use ftnunit
    use precision
    ...
    public :: allPerformCobylaReliabilityTests
...
subroutine allPerformCobylaReliabilityTests
    ...
    call testWithLevel( cobylaReliabilityTest1, "Basic Cobyla Reliability test", 1)

end subroutine allPerformCobylaReliabilityTests
...
subroutine cobylaReliabilityTest1
    ...
    probDb%method%calcMethod = methodCobylaReliability
    probDb%method%cobylaReliability%epsilonBeta = 0.01_wp
    probDb%method%cobylaReliability%maximumIterations = 75
...
end subroutine cobylaReliabilityTest1


end module performCobylaReliabilityTests
