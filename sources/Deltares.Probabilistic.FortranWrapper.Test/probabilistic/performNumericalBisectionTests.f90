...
! All rights reserved.
!
module performNumericalBisectionTests
    use ftnunit
    use precision
    ...
    public :: allPerformNumericalBisectionTests
...
subroutine allPerformNumericalBisectionTests

    call testWithLevel( NumericalBisectionTest1, "Basic Numerical Bisection test", 1)

end subroutine allPerformNumericalBisectionTests


subroutine NumericalBisectionTest1
...
end module performNumericalBisectionTests
