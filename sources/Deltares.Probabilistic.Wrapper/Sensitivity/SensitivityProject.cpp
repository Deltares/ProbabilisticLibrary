    ...
    namespace Sensitivity
    {
        namespace Wrappers
        {
            ...
            Wrappers::SensitivityResult^ SensitivityProject::GetResult()
            {
                ...
                Sensitivity::SensitivityResult nativeResult = shared->object->getSensitivityResult();
                std::shared_ptr<Sensitivity::SensitivityResult> result = std::make_shared<Sensitivity::SensitivityResult>(nativeResult);
