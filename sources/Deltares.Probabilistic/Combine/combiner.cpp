...
namespace Deltares
{
    namespace Reliability
    {
        ...
        std::shared_ptr<Reliability::ReliabilityProject> Combiner::getProject(std::shared_ptr<Reliability::CombinedDesignPointModel> model, std::shared_ptr<Statistics::SelfCorrelationMatrix> selfCorrelationMatrix)
        {
            // create project
