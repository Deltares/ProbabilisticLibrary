...
namespace Deltares
{
    namespace Server
    {
        ...
        public:
            ...
            int GetDesignPointIdsId(std::shared_ptr<Reliability::DesignPointIds> design_point_ids, int newId);
        ...
        private:
            ...
            std::unordered_map<std::shared_ptr<Reliability::DesignPointIds>, int> designPointIdsIds;
