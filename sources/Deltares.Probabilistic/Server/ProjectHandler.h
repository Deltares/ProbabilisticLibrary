...
namespace Deltares
{
    namespace Server
    {
        ...
        public:
            ...
            int GetSensitivityResultId(std::shared_ptr<Uncertainty::UncertaintyResult> result, int newId);
        ...
        private:
            ...
            std::unordered_map<std::shared_ptr<Uncertainty::UncertaintyResult>, int> sensitivityResultsIds;
