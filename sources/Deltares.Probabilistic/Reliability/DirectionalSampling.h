...
namespace Deltares
{
	namespace Reliability
	{
		...
		private:
			...
			std::vector<double> getDirectionBetas(std::shared_ptr<Models::ModelRunner> modelRunner, std::vector<std::shared_ptr<Sample>> samples, double z0, int step, double threshold);
		public:
