...
namespace Deltares
{
    namespace Reliability
    {
        ...
        public:
            ...
            void initialize(std::vector<std::shared_ptr<Models::ModelInputParameter>>& inputParameters, std::vector<std::shared_ptr<Models::ModelInputParameter>>& outputParameters);
