...
namespace Deltares::Reliability
{
    ...
    private:
        std::shared_ptr<DesignPoint> getDesignPoint(const std::shared_ptr<Models::ModelRunner>& modelRunner, Models::Sample& startSample,
        ...
        static std::pair<double, Models::Sample> estimateBetaNonConv(const std::vector<double>& lastBetas, const std::vector<Models::Sample>& last10u);
