	...
	namespace Reliability
	{
		...
		public:
			...
			std::shared_ptr<ImportanceSamplingSettings> clone()
			{
				...
				clone->AutoMaximumSamplesNoResult = this->AutoMaximumSamplesNoResult;
				...
				clone->EpsWeightSample = this->EpsWeightSample;
				clone->MaxClusters = this->MaxClusters;
				clone->MaxVarianceLoops = this->MaxVarianceLoops;
				clone->OptimizeNumberClusters = this->OptimizeNumberClusters;
