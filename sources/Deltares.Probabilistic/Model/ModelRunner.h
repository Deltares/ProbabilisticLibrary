...
namespace Deltares
{
    namespace Models
    {
        ...
        public:
            ...
            Sensitivity::SensitivityResult getSensitivityResult(std::shared_ptr<Statistics::Stochast> stochast) const;
            ...
            void setAllowRepositoryForProxies(bool proxyModel) const;
