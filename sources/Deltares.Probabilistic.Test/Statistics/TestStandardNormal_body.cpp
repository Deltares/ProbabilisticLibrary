...
namespace Deltares::Probabilistic::Test
{
    ...
    void TestStandardNormal::TestPQbetaConversions() const
    {
        ...
        const double a = StandardNormal::getUFromP(0.0);
        const double b = StandardNormal::getUFromQ(0.0);
    ...
    void TestStandardNormal::TestReturnTime() const
    {
        for (int i = -70; i < 70; i++)
        {
            ...
            const double rt = StandardNormal::getTFromU(beta);
            const double beta2 = StandardNormal::getUFromT(rt);
