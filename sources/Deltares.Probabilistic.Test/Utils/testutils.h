...
namespace Deltares::Probabilistic::Test
{
    ...
    public:
        ...
        static void checkAlphaBeta(Reliability::alphaBeta& computed, Reliability::alphaBeta& ref, const double margin);
        static void checkAlphaBeta(Reliability::alphaBeta& computed, Reliability::alphaBeta& ref, const double margin1, const double margin2);
