...
namespace Deltares::Probabilistic::Test
{
    ...
    void TestReliabilityMethods::testValidation()
    {
        ...
        // change method so that relaxation factor is not used anymore
    ...
    void TestReliabilityMethods::testClustersAdpImpSampling()
    {
        ...
        auto expectedCentersE = std::vector({ -0.705994, -0.708218, 0.694748, -0.719253, -0.684285, 0.729214, 0.68589, 0.727705 });
