...
void combinElementsTests::testcombineMultipleElementsSpatialCorrelated1()
{
    ...
    std::string message;
    auto section = up.upscaleLength(CrossSection, rhoXK, dXK, sectionLength, message);
...
void combinElementsTests::testcombineMultipleElementsSpatialCorrelated3()
{
    ...
    std::string message;
    auto section = up.upscaleLength(crossSection, rhoXK, dXK, nElements * sectionLength, message);
