...
namespace Deltares.Probabilistic.Test
{
    ...
    public class TestNumericalIntegration
    {
        ...
        public void TestLinear()
        {
            ...
            ClassicAssert.AreEqual(199.4, designPoint.ReturnPeriod, margin * 10);
        ...
        public void TestLinearProgress()
        {
            ...
            ClassicAssert.AreEqual(200, progressHolder.Invocations);
            ClassicAssert.AreEqual(1, progressHolder.Progress, margin);
            ClassicAssert.AreEqual("200/200, Reliability = 2.576", progressHolder.Text);
        }
