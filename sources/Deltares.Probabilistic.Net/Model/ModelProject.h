...
#include "../../Deltares.Probabilistic/Model/ModelProject.h"
...
namespace Deltares
{
    namespace Models
    {
        namespace Wrappers
        {
            public ref class ModelProject
            {
            private:
                Utils::Wrappers::SharedPointerProvider<Models::ModelProject>* shared = nullptr;
            ...
            protected:
                ...
                void setNativeObject(std::shared_ptr<Models::ModelProject> nativeModelProject)
                {
                    shared = new Utils::Wrappers::SharedPointerProvider(nativeModelProject);
                }

            public:
                ModelProject() { }
                ~ModelProject() { this->!ModelProject(); }
                !ModelProject() { delete shared; }
                ...
                std::shared_ptr<Models::ModelProject> GetModelProject()
                {
