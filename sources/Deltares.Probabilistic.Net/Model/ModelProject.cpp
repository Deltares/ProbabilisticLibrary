...
namespace Deltares
{
    namespace Models
    {
        namespace Wrappers
        {
            ...
            Models::ZLambda ModelProject::getZLambda()
            {
                ManagedSampleDelegate^ fp = gcnew ManagedSampleDelegate(this, &ModelProject::invokeSample);
            ...
            void ModelProject::invokeSample(std::shared_ptr<Models::ModelSample> sample)
            {
