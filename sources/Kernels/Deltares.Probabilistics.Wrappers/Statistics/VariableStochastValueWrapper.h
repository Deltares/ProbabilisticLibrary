...
#include "../../Deltares.Probabilistic.Kernels/Statistics/VariableStochastValue.h"
...
namespace Deltares
{
	namespace Probabilistic
	{
		namespace Kernels
		{
			public ref class VariableStochastValueWrapper
			{
			private:
			...
			public:
				VariableStochastValueWrapper()
				{
					m_value = new Statistics::VariableStochastValue();
				}
				~VariableStochastValueWrapper() { this->!VariableStochastValueWrapper(); }
				!VariableStochastValueWrapper() { delete sharedPointer; }
