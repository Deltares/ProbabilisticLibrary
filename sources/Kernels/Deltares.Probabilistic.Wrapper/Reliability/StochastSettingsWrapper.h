...
namespace Deltares
{
	namespace Reliability
	{
		namespace Wrappers
		{
			...
			public ref class StochastSettingsWrapper
			{
			private:
			...
			public:
				StochastSettingsWrapper() { settings = new Deltares::Reliability::StochastSettings(); }
				~StochastSettingsWrapper() { this->!StochastSettingsWrapper(); }
				!StochastSettingsWrapper() { delete sharedPointer; }
				...
				std::shared_ptr<Deltares::Reliability::StochastSettings> GetSettings()
				{
