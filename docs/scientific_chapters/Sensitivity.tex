...
Sensitivity analysis is a key tool for understanding how variations in input parameters affect the output of a model. By quantifying the influence of different variables, it helps identify the most critical factors, improve model robustness, and support decision-making under uncertainty.

This chapter presents the methods available in the \probLib for conducting a sensitivity analysis.
