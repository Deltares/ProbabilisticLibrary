...
The algorithms implemented in the Probabilistic Suite are described in detail in the `scientific background <https://github.com/Deltares/ProbabilisticLibrary/releases/download/26.1.1/scientific_background.pdf>`_.
